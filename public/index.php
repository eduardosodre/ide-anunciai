...
$router->get('/perfil/profissional/{uuid}', [$professionalController, 'publicGet']);
$router->get('/meu-perfil/igreja', [$churchController, 'meGet']);
$router->post('/meu-perfil/igreja', [$churchController, 'mePost']);
$router->get('/perfil/igreja/{uuid}', [$churchController, 'publicGet']);
...
$router->get('/api/profissionais/{uuid}', [$professionalController, 'publicApiGet']);
$router->get('/api/igrejas/{uuid}', [$churchController, 'publicApiGet']);
